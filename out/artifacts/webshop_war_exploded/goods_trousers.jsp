...
<div class="content">
    ...
    <div class="img_content">
        <ul>
            <li>
                <img src="pic20.jpg" class="img_li">
                <div class="info">
                    <h3>阔腿裤</h3>
                    <p>
                        垂感阔腿夏季西装裤薄款高腰裤宽松大码拖地裤休闲黑色直筒长裤女
                    </p>
                    <div class="img_btn">
            ...
            <li>
                <img src="pic21.jpg" class="img_li">
                <div class="info">
                    <h3>牛仔裤</h3>
                    <p>
                        秋季2021新款白色高腰显瘦直筒宽松牛仔裤女休闲阔腿垂感老爹裤子
                    </p>
                    <div class="img_btn">
                        <div class="price">¥ 31.8</div>
                        <div class="btn">
                            <a href="#" class="cart">
                                <img src="pic4.png">
                            </a>
            ...
            <li>
                <img src="pic22.jpg" class="img_li">
                <div class="info">
                    <h3>破洞裤</h3>
                    <p>
                        渐变破洞牛仔裤女设计感裤子宽松高腰显瘦直筒阔腿裤秋季薄款长裤
                    </p>
                    <div class="img_btn">
