...
<div class="content">
    ...
    <div class="img_content">
        <ul>
            <li>
                <img src="pic17.jpg" class="img_li">
                <div class="info">
                    <h3>连衣裙</h3>
                    <p>
                        2021年新款早秋法式温柔初恋奶甜小个子显高连衣裙气质收腰高级感
                    </p>
                    <div class="img_btn">
            ...
            <li>
                <img src="pic18.jpg" class="img_li">
                <div class="info">
                    <h3>短裙</h3>
                    <p>
                        牛仔裙短裙开叉半身裙女夏季2021新款薄款设计感包臀高腰a字裙子
                    </p>
                    <div class="img_btn">
                        <div class="price">¥ 38.98</div>
                        <div class="btn">
                            <a href="#" class="cart">
                                <img src="pic4.png">
                            </a>
            ...
            <li>
                <img src="pic19.jpg" class="img_li">
                <div class="info">
                    <h3>皮裙</h3>
                    <p>
                        皮裙a字半身裙子女装2021新款遮胯短裙早春秋季高腰显瘦包臀裙
                    </p>
                    <div class="img_btn">
                        <div class="price">¥ 24.8</div>
                        <div class="btn">
                            <a href="#" class="cart">
                                <img src="pic4.png">
                            </a>
