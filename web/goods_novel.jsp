...
<div class="content">
    ...
    <div class="img_content">
        <ul>
            <li>
                <img src="pic25.jpg" class="img_li">
                <div class="info">
                    <h3>《撒野》</h3>
                    <p>
                        正版 撒野1+2+3完结篇 巫哲撒野小说全套正版未删减2020新版 晋江文学青春小说畅销书籍校园套装三册包邮
                    </p>
                    <div class="img_btn">
            ...
            <li>
                <img src="pic26.jpg" class="img_li">
                <div class="info">
                    <h3>《三体》</h3>
                    <p>
                        三体全集 正版 包邮 刘慈欣 科幻小说 三体1三体2黑暗森林三体3死神永生 畅销书 排行榜 中国科幻基石
                    </p>
                    <div class="img_btn">
            ...
            <li>
                <img src="pic27.jpg" class="img_li">
                <div class="info">
                    <h3>《读者》</h3>
                    <p>
                        读者2021合订本春季夏季卷秋季卷 读者文摘校园文学小说杂志青年文摘意林作文素材课外阅读写作素材积累
                    </p>
                    <div class="img_btn">
